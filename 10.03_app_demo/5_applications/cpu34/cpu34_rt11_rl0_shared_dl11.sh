...
p image ../diskimages/rt11v5.5_games_34.rl02.dsk	# mount image file with test pattern
...
.print RL0 content accessible in shared Linux directory "shared_dir"
.print RL11 boot loader installed.
.print Emulated PDP-11/34 CPU will now boot RT11.
...
.print Start CPU34 by toggeling CONT switch with "p c 1"
